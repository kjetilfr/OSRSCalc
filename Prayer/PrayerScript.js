window.onload = run;
	...
	var totalExpGained = 0;
		...
		totalExpGained += CalculateExp(GoblinHeadInput.value,
		EnsouledGoblin.prayer);
		...
		totalExpGained += CalculateExp(MonkeyHeadInput.value,
		EnsouledMonkey.prayer);
		...
		totalExpGained += CalculateExp(ImpHeadInput.value,
		EnsouledImp.prayer);
		...
		totalExpGained += CalculateExp(MiniotaurHeadInput.value,
		EnsouledMiniotaur.prayer);
		...
		totalExpGained += CalculateExp(ScorpionHeadInput.value,
		EnsouledScorpion.prayer);
		...
		totalExpGained += CalculateExp(BearHeadInput.value,
		EnsouledBear.prayer);
		...
		totalExpGained += CalculateExp(UnicornHeadInput.value,
		EnsouledUnicorn.prayer);
		...
		totalExpGained += CalculateExp(DogHeadInput.value,
		EnsouledDog.prayer);
		...
		totalExpGained += CalculateExp(ChaosDruidHeadInput.value,
		EnsouledChaosDruid.prayer);
		...
		totalExpGained += CalculateExp(GiantHeadInput.value,
		EnsouledGiant.prayer);
		...
		totalExpGained += CalculateExp(OgreHeadInput.value,
		EnsouledOgre.prayer);
		...
		totalExpGained += CalculateExp(ElfHeadInput.value,
		EnsouledElf.prayer);
		...
		totalExpGained += CalculateExp(TrollHeadInput.value,
		EnsouledTroll.prayer);
		...
		totalExpGained += CalculateExp(HorrorHeadInput.value,
		EnsouledHorror.prayer);
		...
		totalExpGained += CalculateExp(KalphiteHeadInput.value,
		EnsouledKalphite.prayer);
		...
		totalExpGained += CalculateExp(DagannothHeadInput.value,
		EnsouledDagannoth.prayer);
		...
		totalExpGained += CalculateExp(BloodveldHeadInput.value,
		EnsouledBloodveld.prayer);
		...
		totalExpGained += CalculateExp(TzHaarHeadInput.value,
		EnsouledTzHaar.prayer);
		...
		totalExpGained += CalculateExp(DemonHeadInput.value,
		EnsouledDemon.prayer);
		...
		totalExpGained += CalculateExp(AviansieHeadInput.value,
		EnsouledAviansie.prayer);
		...
		totalExpGained += CalculateExp(AbyssalHeadInput.value,
		EnsouledAbyssal.prayer);
		...
		totalExpGained += CalculateExp(DragonHeadInput.value,
		EnsouledDragon.prayer);
